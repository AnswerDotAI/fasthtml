...
a simple [`Script`](https://answerdotai.github.io/api/xtend.html#script)
or [`Style`](https://answerdotai.github.io/api/xtend.html#style) tag.
But in some cases you will need to write more custom code. FastHTML’s
