...
a simple [`Script`](https://fastht.ml/api/xtend.html#script) or
[`Style`](https://fastht.ml/api/xtend.html#style) tag. But in some cases
you will need to write more custom code. FastHTML’s
