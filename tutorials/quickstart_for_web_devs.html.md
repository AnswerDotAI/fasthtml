...
Line 9  
The [`serve()`](https://fastht.ml/api/core.html#serve) utility
...
The [`Script`](https://fastht.ml/api/xtend.html#script) function allows
you to include JavaScript. You can use Python to generate parts of your
JS or JSON like this:
...
[`Style()`](https://fastht.ml/api/xtend.html#style) function will put
the result into the HTML.

## Other Static Media File Locations

As you saw, [`Script`](https://fastht.ml/api/xtend.html#script) and
...
[`fill_form`](https://fastht.ml/api/components.html#fill_form) class:
...
[`cookie()`](https://fastht.ml/api/core.html#cookie) function. In our
example, we’ll create a `timestamp` cookie.
...
[`Beforeware`](https://fastht.ml/api/core.html#beforeware) class. We
also pass a list of regular expressions to the `skip` argument, designed
to allow users to still get to the home and login pages.
...
[`EventStream`](https://fastht.ml/api/core.html#eventstream)
...
[`Form`](https://fastht.ml/api/xtend.html#form) FT component defaults to
