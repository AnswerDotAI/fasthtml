...
# %% ../nbs/api/05_svg.ipynb #27220120
g = globals()
for o in _all_: g[o] = partial(ft_hx, o[0].lower() + o[1:])

# %% ../nbs/api/05_svg.ipynb #20ed33ef
