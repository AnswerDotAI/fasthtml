...
__all__ = ['named', 'html_attrs', 'hx_attrs', 'show', 'attrmap_x', 'ft_html', 'ft_hx', 'File', 'fill_form', 'fill_dataclass',
           'find_inputs', 'html2ft', 'to_html', 'A', 'Abbr', 'Address', 'Area', 'Article', 'Aside', 'Audio', 'B',
           ...
           'Fencedframe', 'Fieldset', 'Figcaption', 'Figure', 'Footer', 'Form', 'H1', 'Head', 'Header', 'Hgroup', 'Hr',
           'Html', 'I', 'Iframe', 'Img', 'Input', 'Ins', 'Kbd', 'Label', 'Legend', 'Li', 'Link', 'Main', 'Map', 'Mark',
           'Menu', 'Meta', 'Meter', 'Nav', 'Noscript', 'Object', 'Ol', 'Optgroup', 'Option', 'Output', 'P', 'Picture',
...
def to_html(*args, **kwargs):
    "Converts FT Components to XML. Proxy of fastcore.xml.to_xml"
