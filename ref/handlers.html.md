...
The [`FastHTML`](https://fastht.ml/api/core.html#fasthtml) class is the
main application class for FastHTML apps.
...
[`Client`](https://fastht.ml/api/core.html#client) is a test client for
FastHTML applications. It allows you to simulate requests to your app
...
The `get` method on a [`Client`](https://fastht.ml/api/core.html#client)
...
[`Client`](https://fastht.ml/api/core.html#client) instance can simulate
...
[`FT`](https://fastht.ml/docs/explains/explaining_xt_components.html)
...
The [`uri`](https://fastht.ml/api/core.html#uri) function is used to
generate URLs for named routes. It takes the route name as its first
...
[`uri()`](https://fastht.ml/api/core.html#uri), we can dynamically
...
The [`reg_re_param`](https://fastht.ml/api/core.html#reg_re_param)
...
Handler functions can use [`Path`](https://fastht.ml/api/svg.html#path)
objects as parameter types. The
[`Path`](https://fastht.ml/api/svg.html#path) type is from Python’s
standard library `pathlib` module, which provides an object-oriented
interface for working with file paths. In this example, the `path`
parameter is annotated with
[`Path`](https://fastht.ml/api/svg.html#path), so FastHTML automatically
converts the string from the URL to a
[`Path`](https://fastht.ml/api/svg.html#path) object.
...
The [`Client`](https://fastht.ml/api/core.html#client) instance allows
setting custom headers for test requests. Here, we set the ‘User-Agent’
header to ‘FastHTML’ in the test request.
...
[`HtmxHeaders`](https://fastht.ml/api/core.html#htmxheaders). Both
...
[`FastHTML`](https://fastht.ml/api/core.html#fasthtml) application
...
[`FastHTML`](https://fastht.ml/api/core.html#fasthtml). This allows
...
[`HttpHeader`](https://fastht.ml/api/core.html#httpheader) objects.
[`HttpHeader`](https://fastht.ml/api/core.html#httpheader) allows
...
Handler functions can return
[`HtmxResponseHeaders`](https://fastht.ml/api/core.html#htmxresponseheaders)
...
Handler functions can return
[`Redirect`](https://fastht.ml/api/core.html#redirect) objects to
...
- We define a handler that returns a
  [`Redirect`](https://fastht.ml/api/core.html#redirect) object with the
...
The [`Redirect`](https://fastht.ml/api/core.html#redirect) class in
FastHTML implements a `__response__` method, which is a special method
recognized by the framework. When a handler returns a
[`Redirect`](https://fastht.ml/api/core.html#redirect) object, FastHTML
internally calls this `__response__` method to replace the original
response.
...
[`APIRouter`](https://fastht.ml/api/core.html#apirouter) is useful when
you want to split your application routes across multiple `.py` files
that are part of a single FastHTMl application. It accepts an optional
`prefix` argument that will be applied to all routes within that
instance of [`APIRouter`](https://fastht.ml/api/core.html#apirouter).
...
The [`Titled`](https://fastht.ml/api/xtend.html#titled) component is
used to create a page with a title and main content. It automatically
...
The [`cookie()`](https://fastht.ml/api/core.html#cookie) function is
used to create a cookie response. FastHTML automatically converts the
...
The [`cookie()`](https://fastht.ml/api/core.html#cookie) function
returns an [`HttpHeader`](https://fastht.ml/api/core.html#httpheader)
