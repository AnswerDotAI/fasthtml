...
[`FastHTML`](https://answerdotai.github.io/api/core.html#fasthtml) in
your app with `FastHTMLWithLiveReload`.
...
Line 5  
[`serve()`](https://answerdotai.github.io/api/core.html#serve) is a
wrapper around a `uvicorn` call.
