...
[`__getattr__`](https://fastht.ml/api/components.html#__getattr__) and
you can call it yourself to get the same result.
...
>
> In a module
> [`__getattr__`](https://fastht.ml/api/components.html#__getattr__)
...
[`ft_hx`](https://fastht.ml/api/components.html#ft_hx) function to do
that differently than the default.
