...
[`parsed_date`](https://fastht.ml/api/core.html#parsed_date), is an
...
[`qp`](https://fastht.ml/api/core.html#qp) adds query parameters to
route path strings
...
[`qp`](https://fastht.ml/api/core.html#qp) checks to see if each param
should be sent as a query parameter or as part of the route, and encodes
that properly.
...
FastHTML’s [`Client`](https://fastht.ml/api/core.html#client). They
...
*Create a ‘set-cookie’
[`HttpHeader`](https://fastht.ml/api/core.html#httpheader)*
...
and `exts` defined by
[`reg_re_param()`](https://fastht.ml/api/core.html#reg_re_param)*
