...
```
    ...
    datetime.datetime(2025, 4, 14, 14, 0)
...
```
    ...
    Set to 2025-04-01 04:32:55.170296

    'Session time: 2025-04-01 04:32:55.170296'
...
```
    ...
    'Cookie was set at time 04:32:55.373111'
...
<a
href="https://github.com/AnswerDotAI/fasthtml/blob/main/fasthtml/core.py#L800"
target="_blank" style="float:right; font-size:smaller">source</a>
