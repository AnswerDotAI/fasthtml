...
*Async version of
[`nb_serve`](https://fastht.ml/api/jupyter.html#nb_serve)*
...
[`render_ft()`](https://fastht.ml/api/jupyter.html#render_ft), FT
...
[`HTMX`](https://fastht.ml/api/jupyter.html#htmx) function creates an
auto-sizing IFrame for a web app.
