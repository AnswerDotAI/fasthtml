...
[`ft_hx`](https://fastht.ml/api/components.html#ft_hx) version except
...
[`Hidden`](https://fastht.ml/api/xtend.html#hidden) with matching name*
...
sibling, with same vars as [`On`](https://fastht.ml/api/xtend.html#on)*
...
*jsdelivr [`Script`](https://fastht.ml/api/xtend.html#script) or CSS
`Link` tag, or URL*
