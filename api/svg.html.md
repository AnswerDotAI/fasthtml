...
[`ft_svg`](https://fastht.ml/api/svg.html#ft_svg):
...
[`Path`](https://fastht.ml/api/svg.html#path) instead of
[`Rect`](https://fastht.ml/api/svg.html#rect):
...
it with [`SvgOob`](https://fastht.ml/api/svg.html#svgoob) to have it
appear correctly. ([`SvgOob`](https://fastht.ml/api/svg.html#svgoob) is
just a shortcut for `Template(Svg(...))`, which is the trick that makes
SVG OOB swaps work.)
...
[`SvgInb`](https://fastht.ml/api/svg.html#svginb) to have it appear
correctly. ([`SvgInb`](https://fastht.ml/api/svg.html#svginb) is just a
